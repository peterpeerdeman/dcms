...
angular.module('dcms', ['dcms.filters', 'dcms.services', 'dcms.directives', 'dcms.controllers']).
  config(['$routeProvider', function($routeProvider) {
    ...
    $routeProvider.when('/document/overview', {templateUrl: '/assets/angularTemplates/document-overview.html', controller: 'DocumentOverviewCtrl'});
    ...
    $routeProvider.when('/document-type/overview', {templateUrl: '/assets/angularTemplates/document-type-overview.html', controller: 'DocumentTypeOverviewCtrl'});
    $routeProvider.when('/document-type/new', {templateUrl: '/assets/angularTemplates/document-type-new.html', controller: 'NewDocumentTypeCtrl'});
    $routeProvider.when('/document-type/edit/:Id', {templateUrl: '/assets/angularTemplates/document-type-edit.html', controller: 'EditDocumentTypeCtrl'});
